                            ...
                            <Button
                                ...
                                {loadingProvider === "google" ? (
                                    ...
                                    <svg
                                        ...
                                        aria-hidden="true">
                                        <path
                                            d="M22.56 12.25c-.78-.07-1.53-.2-2.25-.2H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"
                                            fill="#4285F4"
                                        />
                                        ...
                                        <path
                                            d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.29V7.06H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.94l2.85-2.22c-.08-.21-.19-.42-.19-.63z"
                                            fill="#FBBC05"
                                        />
