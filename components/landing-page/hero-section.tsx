        ...
        <section className="relative min-h-screen flex items-center overflow-hidden pt-24 pb-40 md:pt-32 md:pb-52 bg-[#1E1B4B]">
            ...
            <div className="wrapper relative z-20">
                <div className="flex flex-col items-center text-center max-w-6xl mx-auto">
                    ...
                    <p className="text-lg md:text-xl text-white/90 max-w-2xl font-medium leading-relaxed mb-12 [text-shadow:0_2px_10px_rgb(0_0_0/0.3)]">
                        Discover remarkable products, share what you&apos;re
                        building, and connect with developers, founders, and
                        makers who care about creating software that people
                        genuinely use.
                    </p>
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-6 mb-24">
                        <Button
                            asChild
                            size="lg"
                            className="h-14 rounded-xl border-2 border-foreground bg-background px-8 text-foreground font-bold shadow-nb-md hover:shadow-none hover:translate-x-0.5 hover:translate-y-0.5 transition-all">
                            <Link
                                href="/submit"
                        ...
                        <Button
                            asChild
                            size="lg"
                            className="h-14 rounded-xl border-2 border-foreground px-8 text-foreground font-bold shadow-nb-md hover:shadow-none hover:translate-x-0.5 hover:translate-y-0.5 transition-all">
                            <Link
                                href="/explore"
                                className="flex items-center gap-3">
                                Explore Projects
                    ...
                    {/* Scroll */}
                    <div className="mt-12 flex flex-col items-center opacity-60 hover:opacity-100 transition-opacity cursor-default">
                        <span className="text-[10px] uppercase tracking-[0.2em] font-black text-white">
                            Discover projects
                        </span>
                        <div className="mt-4 animate-bounce text-3xl text-white">
                            ↓
                        </div>
                    </div>
                </div>
            ...
            <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-none z-10">
                <svg
                    ...
                    className="block w-full h-15 lg:h-25">
                    <path
                        fill="var(--background)"
...
function StatCard({
    ...
    return (
        <div
          ...
          shadow-nb-md hover:shadow-none hover:translate-x-0.5 hover:translate-y-0.5 
